...
0. **Tertullian on Luke, added 2026-08-16, needs a decision.** 38 notes across 20 chapters of Luke now come from *Against Marcion* Book IV (ANF03). Two things a reader should arguably be told. He is not a saint: he ended his life a Montanist, and the notes name him plainly as "Tertullian" with no honorific, which is the same treatment Origen (331 notes) and Victorinus (88) already receive. And the work is polemic rather than exposition, written against Marcion's mutilated Luke, so some notes argue about what Marcion cut rather than expounding the verse. He was added because Luke has almost nothing else: the Catena Aurea on Luke survives only as an OCR scan with marginal glosses interleaved mid-sentence, and Ambrose's Exposition of Luke was first Englished in 1998 and is in copyright. Decide whether he stays, and whether a framing note is wanted as with Victorinus.
