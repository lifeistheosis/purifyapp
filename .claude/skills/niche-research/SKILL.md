...
[
  {
    ...
    "options": [
      ...
      {"label": "Pull from docs/brand/about-purify.md", "description": "Use the niche and audience already in my voice files"}
    ]
  }
]
```

If the user picks "Pull from docs/brand/about-purify.md", read the file from the project root. If the file does not exist or does not name a clear niche, fall back to asking the user to type it.
