...
Wait for the topic. Read docs/brand/newsletter-voice.md, docs/brand/voice.md, and docs/brand/about-purify.md from the project if they exist, so the script matches the user's voice.
...
```
I'm studying this Reel to write my own script in a similar style for my audience of [AUDIENCE FROM docs/brand/about-purify.md].
...
- Always read docs/brand/voice.md and docs/brand/about-purify.md before writing. Voice match is non-negotiable.
