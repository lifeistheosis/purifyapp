...
Check the project for docs/brand/about-purify.md. If it exists, pre-fill name, audience, topics, and POV from it. Skip those questions and tell the user what you pulled.
...
[
  ...
  },
  {
    ...
    "options": [
      ...
      {"label": "Start fresh", "description": "Ignore my current profile, build from scratch using my docs/brand/about-purify.md"},
...
- Always read docs/brand/about-purify.md if it exists and pre-fill inputs from it.
