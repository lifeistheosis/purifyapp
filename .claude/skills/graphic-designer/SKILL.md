...
- Footer with author name from docs/brand/about-purify.md if available
...
Always include the handwritten text "[Author name from docs/brand/about-purify.md] | Repost" at the bottom of the image, in the same hand-drawn marker style.
```

### Style 2: Branded infographic

Ask the user for brand colours if not already known. If docs/brand/about-purify.md exists, check there first.
...
FOOTER:
[Author name from docs/brand/about-purify.md] | [CTA or tagline if appropriate]
