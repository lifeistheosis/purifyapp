...
Check the project for docs/brand/about-purify.md. If it exists, read it and pre-fill the description of who the user is. Skip that question and tell the user what you pulled.

If docs/brand/about-purify.md is missing, ask:
...
[
  {
    ...
    "options": [
      ...
      {"label": "Pull from docs/brand/voice.md", "description": "Use the topics already defined in my voice files"},
      {"label": "Suggest them for me", "description": "Based on my docs/brand/about-purify.md, recommend 4 pillars"}
    ]
  }
]
```
...
If the user picks "Suggest them for me", read docs/brand/about-purify.md, propose 4 pillars covering their positioning, and ask them to confirm or edit before continuing.
...
- Tune the language to the user's voice if docs/brand/voice.md exists.
- British English unless docs/brand/voice.md specifies American.
- Never use em dashes.
