...
const ENTRIES: Entry[] = [
 ...
 items: [
  ...
  "Context for the hard verses. Tapping the verse number on 1 Samuel 15:3, the command against Amalek, now opens St. Augustine answering the very charge that such commands are cruel, verbatim from his Reply to Faustus the Manichaean. Asked for on the Discord by Gheara.",
  ...
  "The Reader settings menu no longer clips off the edge on phones. Opened from the Reader chip, the panel of size, font, and line-spacing controls was anchored to the wrong side and ran past the left margin; it now opens into the page on every width.",
