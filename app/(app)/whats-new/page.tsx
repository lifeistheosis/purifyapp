...
const ENTRIES: Entry[] = [
 ...
 items: [
    ...
    "Sign in with Apple. The sign-in screen has carried a greyed-out Apple button labelled coming soon since it was built, and the connected-accounts screen said coming soon even to readers whose account was already linked through Apple. It works now, on the iPhone app and on the website. It is not offered in the Android app, where Apple provides no way to do it properly and the alternative is a button that fails after you have committed to it. It depends on configuration held outside the app, so if the button is present and does not complete, that is the reason and it is ours to fix, not anything you have done.",
