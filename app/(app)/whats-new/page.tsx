...
const ENTRIES: Entry[] = [
 ...
 items: [
    ...
    "The saints of August have their faces. Thirty-eight saints in the app had no icon, and thirty-seven of them keep a feast in August, so for most of this month the day's commemoration was a pair of initials on a chip. Thirty-six have one now, and St George, who had no entry in the app at all, has both an entry and an icon. Two were refused rather than shipped: a Renaissance portrait of the wrong Sixtus, four popes and eleven centuries from the martyr the day keeps, and a narrow crop with the neighbouring saint's name still in frame. Every file was opened and read against its own inscription before it was filed, because a licence tells you nothing about who is in the picture. The whole directory was also re-encoded to the size it is actually drawn at, which took it from 18.1 MB to 4.3 MB inside both app bundles.",
