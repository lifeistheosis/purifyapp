    ...
    <>
      ...
      <section className={HERO + " bg-night"}>
        <div className="mx-auto max-w-[860px] w-full text-center">
          ...
          <p className="mt-5 font-sans text-body text-paper/70 max-w-[560px] mx-auto">
          ...
          <p className="mt-3 font-sans italic text-caption text-paper/40">
      ...
      >
        <div className="mx-auto max-w-[860px] w-full">
          <p className="font-sans text-caption font-semibold uppercase tracking-[1.5px] text-paper/50 mb-4">
            Sources &amp; notes
          </p>
          <ul className="space-y-2 font-sans text-detail text-paper/55 leading-[1.65]">
            <li>
