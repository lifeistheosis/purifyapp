  ...
  return (
    <section className="bg-night px-5 md:px-8 py-12 md:py-20">
      <div className="mx-auto max-w-[920px] w-full">
            ...
            <li key={l.id}>
              ...
              >
                <div className="flex items-start gap-5">
                  <span className="font-serif text-title text-paper/45 leading-none shrink-0 w-8 text-right">
                    {l.order}
                  </span>
                  <div className="min-w-0 flex-1">
                    <h2 className="font-sans text-lede font-semibold text-paper">
                      {l.title}
                    </h2>
                    <p className="mt-1 font-sans text-ui text-paper/65 leading-[1.55]">
                      {l.summary}
                    </p>
                    <p className="mt-2 font-sans text-eyebrow uppercase tracking-[1.2px] text-paper/35">
                      {l.estimatedMinutes} {isDe ? "Min." : "min"}
                    </p>
                  </div>
                  <span
                    aria-hidden
                    className="self-center text-paper/35 text-body"
                  >
                    →
                  </span>
                </div>
        ...
        <p className="mt-10 font-sans text-caption text-paper/40 leading-[1.6] max-w-[640px]">
          {isDe
