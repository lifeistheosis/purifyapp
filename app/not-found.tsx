  ...
  return (
    <main className="min-h-screen bg-night flex items-center justify-center px-5 py-16">
      <div className="mx-auto max-w-[640px] w-full text-center">
        ...
        <h1 className="font-serif text-[44px] md:text-[56px] text-paper leading-[1.1]">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <Link
            href="/bible"
            className="rounded-md border border-paper/15 bg-paper/[0.04] hover:border-paper/35 hover:bg-paper/[0.08] transition-colors px-5 py-4 font-sans text-[14px] font-medium text-paper"
          >
            The Bible →
          </Link>
          <Link
        ...
        <p className="mt-10 font-sans text-[13px] text-paper/45">
          Or{" "}
