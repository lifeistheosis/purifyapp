...
export default function Home() {
 ...
 <span className="sm:hidden">v5.7 · The Apostolic Fathers, complete</span>
 <span className="hidden sm:inline">v5.7 · The Apostolic Fathers, the whole way through</span>
 </span>
