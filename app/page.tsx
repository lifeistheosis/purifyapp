...
export default function Home() {
 ...
 <span className="sm:hidden">v5.9 · Nicaea refined, Constantinople opened</span>
 <span className="hidden sm:inline">v5.9 · Nicaea refined, the Second Council opens</span>
 </span>
