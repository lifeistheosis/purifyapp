...
/**
 * Stripe returns here after payment. Deliberately quiet: the order id comes
 * from our own database (passed on the success URL), the webhook settles the
 * payment state, and /shop/orders shows the living status. Reads the id
