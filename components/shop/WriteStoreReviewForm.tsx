...
/** The verified-buyer store-review form: a star picker, an optional note, a
 *  location, and a choice to post anonymously. Mirrors WriteReviewForm but
 *  writes a review of the store itself. */
export function WriteStoreReviewForm({
  storeId,
  storeName,
  onSubmitted,
}: {
    ...
    >
      ...
      <label className="mt-3 block">
        ...
        <textarea
          ...
          rows={3}
          maxLength={4000}
          placeholder={`How was your experience with ${storeName}? (optional)`}
          className={field}
        />
      </label>
