    ...
    <section className="bg-gold/[0.06] border-y border-gold/25 px-5 md:px-8 py-5">
      <div className="mx-auto max-w-[1240px] w-full flex items-center justify-between gap-4 flex-wrap">
        <div className="min-w-0 flex-1">
          <p className="font-sans text-[10.5px] font-semibold uppercase tracking-[2px] text-gold/85">
            We are in
          </p>
        ...
        <Link
          href={season.href}
          className="shrink-0 inline-flex items-center gap-2 rounded-pill border border-gold/55 bg-gold/15 hover:bg-gold/25 px-4 h-[40px] font-sans text-[13px] font-medium text-paper transition-colors"
        >
          Open the calendar →
        </Link>
      </div>
