...
function EventChip({ slug }: { slug: string }) {
  ...
  return (
    ...
    >
      <span className="font-sans text-caption text-paper/45">{e.displayDate}</span>
      ...
      {preceded.length || resulted.length ? (
        <div className="mb-10">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {preceded.length ? (
              <div>
                <p className="mb-2 font-sans text-caption uppercase tracking-[1.4px] text-paper/40">
                  What led here
                </p>
                  ...
                  {g.links.map((l) => (
                    <li key={l.href}>
                      ...
                      >
                        {l.label}
                        {l.sublabel ? (
                          <span className="text-paper/40"> · {l.sublabel}</span>
                        ) : null}
                      </Link>
                    </li>
                  ))}
