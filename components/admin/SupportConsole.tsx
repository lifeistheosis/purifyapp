...
/**
 * The ticket's status, in the panel's shared Select. This was the first custom
 * picker in the admin, written to get away from the native <select>; the
 * shared one is this made general, so the two no longer drift.
 */
